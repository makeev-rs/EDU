...
subaru = SportCar(100, 'Red', 'subaru', False)
nissan = TownCar(30, 'White', 'nissan', False)
toyota = WorkCar(70, 'Rose', 'toyota', True)
ford = PoliceCar(110, 'Blue', 'Ford', True)
print(toyota.turn_left())
print(f'When {nissan.turn_right()}, then {subaru.stop()}')
